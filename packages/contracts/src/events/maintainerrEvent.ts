export enum MaintainerrEvent {
  ...
  CollectionMedia_ApprovalRequested = 'collection_media.approval_requested',
  CollectionMedia_ApprovalApproved = 'collection_media.approval_approved',
  CollectionMedia_ApprovalRejected = 'collection_media.approval_rejected',
